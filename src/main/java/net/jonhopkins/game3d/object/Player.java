...
import net.jonhopkins.game3d.script.FirstPersonCharacterController;
...
public class Player extends Prefab {
	public Player(Camera camera, MapSector sector) {
		CharacterController characterController = new FirstPersonCharacterController(this, camera);
